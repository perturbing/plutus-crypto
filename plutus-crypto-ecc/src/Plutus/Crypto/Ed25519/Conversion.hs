...
builtinByteStringToInteger bs = let g x = lengthOfByteString x - 1
                                ...
                                in go bs
{-# INLINABLE builtinByteStringToInteger #-}
...
{-# INLINABLE integerToBuiltinByteString32Length #-}
...
{-# INLINABLE ed25519_G_deserialise #-}